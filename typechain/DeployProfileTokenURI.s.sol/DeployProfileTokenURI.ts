...
export interface DeployProfileTokenURIInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "IS_SCRIPT" | "run" | "testForkManagement"
  ): FunctionFragment;
...
export interface DeployProfileTokenURI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployProfileTokenURIInterface;
