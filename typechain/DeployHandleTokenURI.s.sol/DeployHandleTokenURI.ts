...
export interface DeployHandleTokenURIInterface extends utils.Interface {
  functions: {
...
export interface DeployHandleTokenURI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployHandleTokenURIInterface;
