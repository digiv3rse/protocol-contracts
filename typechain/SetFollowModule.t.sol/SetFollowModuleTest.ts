...
export interface SetFollowModuleTestInterface extends utils.Interface {
  functions: {
...
export interface SetFollowModuleTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetFollowModuleTestInterface;
