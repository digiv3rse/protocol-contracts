...
export interface IDiGiGovernableInterface extends utils.Interface {
  functions: {
...
export interface IDiGiGovernable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDiGiGovernableInterface;
