...
export interface ILegacyCollectNFTInterface extends utils.Interface {
  functions: {
...
export interface ILegacyCollectNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILegacyCollectNFTInterface;
