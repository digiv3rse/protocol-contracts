...
export interface ActMetaTxTestInterface extends utils.Interface {
  functions: {
    ...
    "testActionMetaTxTest()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testActionMetaTxTest",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ActMetaTxTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ActMetaTxTestInterface;
  ...
  callStatic: {
    ...
    testActionMetaTxTest(overrides?: CallOverrides): Promise<void>;
