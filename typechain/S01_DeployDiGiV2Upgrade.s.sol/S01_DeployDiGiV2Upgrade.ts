...
export interface S01_DeployDiGiV2UpgradeInterface extends utils.Interface {
  functions: {
    "IS_SCRIPT()": FunctionFragment;
    "testArrayHelpers()": FunctionFragment;
    "testDiGiV2UpgradeDeployment()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDiGiV2UpgradeDeployment",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface S01_DeployDiGiV2Upgrade extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: S01_DeployDiGiV2UpgradeInterface;
  ...
  callStatic: {
    ...
    testDiGiV2UpgradeDeployment(overrides?: CallOverrides): Promise<void>;
