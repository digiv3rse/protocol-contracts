...
export interface TokenGuardianTest_Default_OffInterface
...
export interface TokenGuardianTest_Default_Off extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenGuardianTest_Default_OffInterface;
