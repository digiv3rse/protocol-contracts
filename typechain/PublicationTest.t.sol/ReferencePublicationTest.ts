...
export interface ReferencePublicationTestInterface extends utils.Interface {
  functions: {
...
export interface ReferencePublicationTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReferencePublicationTestInterface;
