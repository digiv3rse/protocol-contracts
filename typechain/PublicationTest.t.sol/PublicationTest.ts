...
export interface PublicationTestInterface extends utils.Interface {
  functions: {
...
export interface PublicationTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PublicationTestInterface;
