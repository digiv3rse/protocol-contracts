...
export interface DiGiHubEventHooksTestInterface extends utils.Interface {
  functions: {
    ...
    "testCannot_EmitCollectNFTTransferEvent_IfNotCollectNFTOfPublication(address)": FunctionFragment;
    "testCannot_EmitUnfollowedEvent_ifNotFollowNFTOfFollowedProfile(address,address)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testEmitCollectNFTTransferEvent_ForRealThisTime(uint256,address,address)": FunctionFragment;
    "testEmitUnfollowedEvent_ifFollowNFTOfFollowedProfile(address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testArrayHelpers"
      | "testBaseTest"
      | "testCannot_EmitCollectNFTTransferEvent_IfNotCollectNFTOfPublication"
      | "testCannot_EmitUnfollowedEvent_ifNotFollowNFTOfFollowedProfile"
      | "testContractAddressesLoaderDeployer"
      | "testEmitCollectNFTTransferEvent_ForRealThisTime"
      | "testEmitUnfollowedEvent_ifFollowNFTOfFollowedProfile"
      | "testForkManagement"
      | "testKeyExists"
      | "testTestSetup"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCannot_EmitCollectNFTTransferEvent_IfNotCollectNFTOfPublication",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannot_EmitUnfollowedEvent_ifNotFollowNFTOfFollowedProfile",
    values: [string, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testEmitCollectNFTTransferEvent_ForRealThisTime",
    values: [BigNumberish, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testEmitUnfollowedEvent_ifFollowNFTOfFollowedProfile",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface DiGiHubEventHooksTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DiGiHubEventHooksTestInterface;
