...
export interface BaseFeeCollectModuleBaseInterface extends utils.Interface {
  functions: {
...
export interface BaseFeeCollectModuleBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseFeeCollectModuleBaseInterface;
