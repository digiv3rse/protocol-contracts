...
export interface DeployFollowTokenURIInterface extends utils.Interface {
  functions: {
...
export interface DeployFollowTokenURI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployFollowTokenURIInterface;
