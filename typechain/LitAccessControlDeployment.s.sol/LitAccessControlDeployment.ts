...
export interface LitAccessControlDeploymentInterface extends utils.Interface {
  functions: {
    "IS_SCRIPT()": FunctionFragment;
    "run(string)": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testLitAccessControlDeployment()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "run"
      | "testForkManagement"
      | "testLitAccessControlDeployment"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testLitAccessControlDeployment",
    values?: undefined
  ): string;
...
export interface LitAccessControlDeployment extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LitAccessControlDeploymentInterface;
  ...
  callStatic: {
    ...
    testLitAccessControlDeployment(overrides?: CallOverrides): Promise<void>;
  };
