...
export interface SetBlockStatusTestInterface extends utils.Interface {
  functions: {
...
export interface SetBlockStatusTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetBlockStatusTestInterface;
