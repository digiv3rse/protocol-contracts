...
export interface BaseFeeCollectModule_InitializationInterface
  ...
  encodeFunctionData(
    functionFragment: "testInitializeWithCorrectInitData",
    values: [
      BigNumberish,
      BigNumberish,
      string,
...
export interface BaseFeeCollectModule_Initialization extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseFeeCollectModule_InitializationInterface;
