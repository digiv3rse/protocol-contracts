...
export interface BaseFeeCollectModule_ProcessCollectInterface
...
export interface BaseFeeCollectModule_ProcessCollect extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseFeeCollectModule_ProcessCollectInterface;
