...
export interface BaseFeeCollectModule_FeeDistributionInterface
  ...
  functions: {
    ...
    "testVerifyFeesSplit(uint256,uint256,address,uint160,uint16,address,uint16,address,uint256)": FunctionFragment;
  };
...
export interface BaseFeeCollectModule_FeeDistribution extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseFeeCollectModule_FeeDistributionInterface;
