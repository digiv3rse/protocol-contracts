...
export interface FollowSVGGenInterface extends utils.Interface {
  functions: {
    ...
    "testFollowSVGGen()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFollowSVGGen",
    values?: undefined
  ): string;
...
export interface FollowSVGGen extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FollowSVGGenInterface;
  ...
  callStatic: {
    ...
    testFollowSVGGen(overrides?: CallOverrides): Promise<void>;
  };
