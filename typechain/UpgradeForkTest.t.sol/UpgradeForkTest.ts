...
export interface UpgradeForkTestInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "testDiGiUpgradeVersion",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testUpgradeV1toV2",
    values?: undefined
  ): string;
...
export interface UpgradeForkTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UpgradeForkTestInterface;
  ...
  callStatic: {
    ...
    testDiGiUpgradeVersion(overrides?: CallOverrides): Promise<void>;
    ...
    testUpgradeV1toV2(overrides?: CallOverrides): Promise<void>;
  };
