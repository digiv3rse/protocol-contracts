...
export interface MetaTxNegativesInterface extends utils.Interface {
  functions: {
...
export interface MetaTxNegatives extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MetaTxNegativesInterface;
