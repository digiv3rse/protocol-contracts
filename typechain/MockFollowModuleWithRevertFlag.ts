...
export interface MockFollowModuleWithRevertFlagInterface
  ...
  functions: {
    ...
    "testMockFollowModuleWithRevertFlag()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "supportsInterface"
      | "testMockFollowModuleWithRevertFlag"
      | "transferOwnership"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testMockFollowModuleWithRevertFlag",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MockFollowModuleWithRevertFlag extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockFollowModuleWithRevertFlagInterface;
