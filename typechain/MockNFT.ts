...
export interface MockNFT extends BaseContract {
  ...
  callStatic: {
    ...
    testMockNFT(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    testMockNFT(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
