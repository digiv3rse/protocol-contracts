...
export interface TokenHandleRegistryUnlinkMetaTxTestInterface
  ...
  functions: {
    ...
    "testCannot_UnlinkWithSig_IfWalletValidationFails()": FunctionFragment;
    ...
    "testUnlinkWithSig(address)": FunctionFragment;
    "testUnlinkWithSig_WithERC1271Wallet()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testCannot_UnlinkWithSig_IfWalletValidationFails"
      | "testContractAddressesLoaderDeployer"
      | "testForkManagement"
      | "testKeyExists"
      | "testTestSetup"
      | "testUnlinkWithSig"
      | "testUnlinkWithSig_WithERC1271Wallet"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCannot_UnlinkWithSig_IfWalletValidationFails",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testUnlinkWithSig",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "testUnlinkWithSig_WithERC1271Wallet",
    values?: undefined
  ): string;
...
export interface TokenHandleRegistryUnlinkMetaTxTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenHandleRegistryUnlinkMetaTxTestInterface;
