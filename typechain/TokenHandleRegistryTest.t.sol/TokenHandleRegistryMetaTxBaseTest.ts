...
export interface TokenHandleRegistryMetaTxBaseTestInterface
...
export interface TokenHandleRegistryMetaTxBaseTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenHandleRegistryMetaTxBaseTestInterface;
