...
export interface TokenHandleRegistryLinkMetaTxTestInterface
  ...
  functions: {
    ...
    "testCannot_LinkWithSig_IfWalletValidationFails()": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testFreshLinkWithSig(address)": FunctionFragment;
    "testFreshLinkWithSig_WithERC1271Wallet()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testCannot_LinkWithSig_IfWalletValidationFails"
      | "testContractAddressesLoaderDeployer"
      | "testForkManagement"
      | "testFreshLinkWithSig"
      | "testFreshLinkWithSig_WithERC1271Wallet"
      | "testKeyExists"
      | "testTestSetup"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCannot_LinkWithSig_IfWalletValidationFails",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testFreshLinkWithSig",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "testFreshLinkWithSig_WithERC1271Wallet",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TokenHandleRegistryLinkMetaTxTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenHandleRegistryLinkMetaTxTestInterface;
