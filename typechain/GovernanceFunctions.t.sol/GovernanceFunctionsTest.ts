...
export interface GovernanceFunctionsTestInterface extends utils.Interface {
  functions: {
    ...
    "testCannot_SetEmergencyAdmin_IfNotGovernance(address,address)": FunctionFragment;
    "testCannot_SetGovernance_IfNotGovernance(address,address)": FunctionFragment;
    "testCannot_SetState_IfNotGovernanceOrEmergencyAdmin(address,uint8)": FunctionFragment;
    "testCannot_Unpause_IfEmergencyAdmin(uint8,uint8)": FunctionFragment;
    "testCannot_WhitelistProfileCreator_IfNotGovernance(address,address,bool)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testKeyExists()": FunctionFragment;
    "testSetEmergencyAdmin_IfGovernance(address)": FunctionFragment;
    "testSetGovernance_IfGovernance(address)": FunctionFragment;
    "testSetState_IfGovernance(uint8)": FunctionFragment;
    "testSetState_IfGovernance_AndItIsSameAsEmergencyAdmin(uint8)": FunctionFragment;
    "testTestSetup()": FunctionFragment;
    "testWhitelistProfileCreator(address,bool)": FunctionFragment;
    "test_EmergencyAdminCanOnlyPauseFurtherDown(uint8,uint8)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testArrayHelpers"
      | "testBaseTest"
      | "testCannot_SetEmergencyAdmin_IfNotGovernance"
      | "testCannot_SetGovernance_IfNotGovernance"
      | "testCannot_SetState_IfNotGovernanceOrEmergencyAdmin"
      | "testCannot_Unpause_IfEmergencyAdmin"
      | "testCannot_WhitelistProfileCreator_IfNotGovernance"
      | "testContractAddressesLoaderDeployer"
      | "testForkManagement"
      | "testKeyExists"
      | "testSetEmergencyAdmin_IfGovernance"
      | "testSetGovernance_IfGovernance"
      | "testSetState_IfGovernance"
      | "testSetState_IfGovernance_AndItIsSameAsEmergencyAdmin"
      | "testTestSetup"
      | "testWhitelistProfileCreator"
      | "test_EmergencyAdminCanOnlyPauseFurtherDown"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCannot_SetEmergencyAdmin_IfNotGovernance",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannot_SetGovernance_IfNotGovernance",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannot_SetState_IfNotGovernanceOrEmergencyAdmin",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannot_Unpause_IfEmergencyAdmin",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannot_WhitelistProfileCreator_IfNotGovernance",
  ...
  encodeFunctionData(
    functionFragment: "testSetEmergencyAdmin_IfGovernance",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "testSetGovernance_IfGovernance",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "testSetState_IfGovernance",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testSetState_IfGovernance_AndItIsSameAsEmergencyAdmin",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testWhitelistProfileCreator",
    values: [string, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "test_EmergencyAdminCanOnlyPauseFurtherDown",
    values: [BigNumberish, BigNumberish]
  ): string;
...
export interface GovernanceFunctionsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceFunctionsTestInterface;
  ...
  functions: {
    ...
    testCannot_SetState_IfNotGovernanceOrEmergencyAdmin(
      nonGovernanceOrEmergencyAdmin: string,
      state: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    testCannot_Unpause_IfEmergencyAdmin(
      emergencyState: BigNumberish,
      unpausingState: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
