...
export interface IDiGiHandlesInterface extends utils.Interface {
  functions: {
    ...
    "getHandleTokenURIContract()": FunctionFragment;
    ...
    "setHandleTokenURIContract(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getHandleTokenURIContract",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setHandleTokenURIContract",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface IDiGiHandles extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDiGiHandlesInterface;
  ...
  functions: {
    ...
    getHandleTokenURIContract(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getHandleTokenURIContract(overrides?: CallOverrides): Promise<BigNumber>;
