...
export interface RevertFollowModuleTestInterface extends utils.Interface {
  functions: {
    ...
    "testCannotProcessFollow(address,uint256,uint256,address,uint256)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testInitialize(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCannotProcessFollow",
...
export interface RevertFollowModuleTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RevertFollowModuleTestInterface;
