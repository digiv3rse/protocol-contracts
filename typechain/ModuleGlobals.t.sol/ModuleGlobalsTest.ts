...
export interface ModuleGlobalsTestInterface extends utils.Interface {
  functions: {
...
export interface ModuleGlobalsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ModuleGlobalsTestInterface;
