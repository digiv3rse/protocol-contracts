...
export interface PostMetaTxTestInterface extends utils.Interface {
  functions: {
    ...
    "testPostMetaTxTest()": FunctionFragment;
    "testPostTest()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testPostMetaTxTest",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testPostTest",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PostMetaTxTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PostMetaTxTestInterface;
  ...
  callStatic: {
    ...
    testPostMetaTxTest(overrides?: CallOverrides): Promise<void>;

    testPostTest(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    testPostTest(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
