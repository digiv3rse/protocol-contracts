...
export interface DiGiImplGettersInterface extends utils.Interface {
  functions: {
...
export interface DiGiImplGetters extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DiGiImplGettersInterface;
