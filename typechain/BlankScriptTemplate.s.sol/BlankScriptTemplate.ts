...
export interface BlankScriptTemplateInterface extends utils.Interface {
  functions: {
...
export interface BlankScriptTemplate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlankScriptTemplateInterface;
