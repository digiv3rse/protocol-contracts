...
export interface ReferralSystemTestInterface extends utils.Interface {
  functions: {
...
export interface ReferralSystemTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReferralSystemTestInterface;
