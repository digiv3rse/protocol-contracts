...
export interface MultirecipientCollectModule_ProcessCollectInterface
  ...
  functions: {
    ...
    "testCanCollectIfAllConditionsAreMet(uint256,address,uint160,uint96,uint16,bool,uint72,uint72,address,address)": FunctionFragment;
    "testCannotCollectIfNotAFollower(uint256,uint256,address,address)": FunctionFragment;
    "testCannotCollectMoreThanLimit(uint256,uint256,address,uint256,address)": FunctionFragment;
    "testCannotProcessCollect_AfterEndTimestamp(uint256,uint256,address,uint256,address,uint72,uint72)": FunctionFragment;
    "testCannotProcessCollect_IfCalledFrom_NonActionModuleAddress(uint256,uint256,uint256,address,address,address)": FunctionFragment;
    "testCannotProcessCollect_PassingWrongAmountInData(uint256,uint256,address,uint160,uint160,uint256,address)": FunctionFragment;
    "testCannotProcessCollect_PassingWrongCurrencyInData(uint256,uint256,address,uint160,address,uint256,address)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testCurrentCollectsIncreaseProperlyWhenCollecting(uint256,uint256,uint256,address,address)": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testKeyExists()": FunctionFragment;
    "testMultirecipientCollectModuleBase()": FunctionFragment;
    "testMultirecipientCollectModule_Collect()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testMultirecipientCollectModule_Collect"
      | "testTestSetup"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCanCollectIfAllConditionsAreMet",
    values: [
      BigNumberish,
      string,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "testCannotCollectIfNotAFollower",
    values: [BigNumberish, BigNumberish, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotCollectMoreThanLimit",
    values: [BigNumberish, BigNumberish, string, BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotProcessCollect_AfterEndTimestamp",
    values: [
      BigNumberish,
      BigNumberish,
      string,
  ...
  encodeFunctionData(
    functionFragment: "testCannotProcessCollect_IfCalledFrom_NonActionModuleAddress",
    values: [BigNumberish, BigNumberish, BigNumberish, string, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotProcessCollect_PassingWrongAmountInData",
    values: [
      BigNumberish,
      BigNumberish,
      string,
  ...
  encodeFunctionData(
    functionFragment: "testCannotProcessCollect_PassingWrongCurrencyInData",
    values: [
      BigNumberish,
      BigNumberish,
      string,
  ...
  encodeFunctionData(
    functionFragment: "testCurrentCollectsIncreaseProperlyWhenCollecting",
  ...
  encodeFunctionData(
    functionFragment: "testMultirecipientCollectModule_Collect",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MultirecipientCollectModule_ProcessCollect
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultirecipientCollectModule_ProcessCollectInterface;
