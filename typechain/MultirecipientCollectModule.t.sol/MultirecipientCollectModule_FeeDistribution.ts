...
export interface MultirecipientCollectModule_FeeDistributionInterface
  ...
  functions: {
    ...
    "testVerifyFeesSplit(uint160,uint16,uint16,address,uint16,uint16,uint16,uint16,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testVerifyFeesSplit",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export interface MultirecipientCollectModule_FeeDistribution
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultirecipientCollectModule_FeeDistributionInterface;
  ...
  functions: {
    ...
    testVerifyFeesSplit(
      ...
      split3: BigNumberish,
      split4: BigNumberish,
      numberOfRecipients: BigNumberish,
      numberOfReferrals: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  };
