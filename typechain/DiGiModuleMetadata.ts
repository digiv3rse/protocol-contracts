...
export interface DiGiModuleMetadataInterface extends utils.Interface {
  functions: {
...
export interface DiGiModuleMetadata extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DiGiModuleMetadataInterface;
