...
export interface ERC721SeaDropCloneableInterface extends utils.Interface {
  functions: {
...
export interface ERC721SeaDropCloneable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721SeaDropCloneableInterface;
