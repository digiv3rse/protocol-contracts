...
export interface ProfileMetadataURITest_MetaTxInterface
  ...
  functions: {
    ...
    "testCannotSetProfileMetadataURINotDelegatedExecutor(uint256)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testDelegatedExecutorSetProfileMetadataURI(uint256)": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testKeyExists()": FunctionFragment;
    "testProfileMetadataURITest_MetaTx()": FunctionFragment;
    "testSetProfileMetadataURI()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testCannotSetProfileMetadataURINotDelegatedExecutor"
      | "testContractAddressesLoaderDeployer"
      | "testDelegatedExecutorSetProfileMetadataURI"
      | "testForkManagement"
      | "testKeyExists"
      | "testProfileMetadataURITest_MetaTx"
  ...
  encodeFunctionData(
    functionFragment: "testCannotSetProfileMetadataURINotDelegatedExecutor",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testDelegatedExecutorSetProfileMetadataURI",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testProfileMetadataURITest_MetaTx",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSetProfileMetadataURI",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ProfileMetadataURITest_MetaTx extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProfileMetadataURITest_MetaTxInterface;
  ...
  callStatic: {
    ...
    testProfileMetadataURITest_MetaTx(overrides?: CallOverrides): Promise<void>;

    testSetProfileMetadataURI(overrides?: CallOverrides): Promise<void>;
