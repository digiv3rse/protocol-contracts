...
export interface ProfileMetadataURITestInterface extends utils.Interface {
  functions: {
...
export interface ProfileMetadataURITest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProfileMetadataURITestInterface;
