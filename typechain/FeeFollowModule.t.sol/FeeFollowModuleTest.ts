...
export interface FeeFollowModuleTestInterface extends utils.Interface {
  functions: {
    ...
    "testCanProcessFollow(uint256,uint256,uint256,address,address,uint256,uint16)": FunctionFragment;
    "testCanStillProcessFollow_ZeroCurrency(uint256,uint256,address,address)": FunctionFragment;
    "testCannotInitialize_NotHub(address,uint256,uint256,address)": FunctionFragment;
    "testCannotInitialize_ZeroAmount(uint256,address)": FunctionFragment;
    "testCannotProcessFollow_WrongAmountPassed_FreshFollow(uint256,uint256,uint256,uint256,address,address)": FunctionFragment;
    "testCannotProcessFollow_WrongAmountPassed_ReusingFollow(uint256,uint256,uint256,uint256,address,address,uint256)": FunctionFragment;
    "testCannotProcessFollow_WrongCurrencyPassed_FreshFollow(uint256,uint256,uint256,address,address,address)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testInitialize(uint256,uint256,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testArrayHelpers"
      | "testBaseTest"
      | "testCanProcessFollow"
      | "testCanStillProcessFollow_ZeroCurrency"
      | "testCannotInitialize_NotHub"
      | "testCannotInitialize_ZeroAmount"
      | "testCannotProcessFollow_WrongAmountPassed_FreshFollow"
      | "testCannotProcessFollow_WrongAmountPassed_ReusingFollow"
      | "testCannotProcessFollow_WrongCurrencyPassed_FreshFollow"
  ...
  encodeFunctionData(
    functionFragment: "testCanProcessFollow",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "testCanStillProcessFollow_ZeroCurrency",
    values: [BigNumberish, BigNumberish, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotInitialize_NotHub",
    values: [string, BigNumberish, BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotInitialize_ZeroAmount",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotProcessFollow_WrongAmountPassed_FreshFollow",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "testCannotProcessFollow_WrongAmountPassed_ReusingFollow",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "testCannotProcessFollow_WrongCurrencyPassed_FreshFollow",
...
export interface FeeFollowModuleTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeFollowModuleTestInterface;
