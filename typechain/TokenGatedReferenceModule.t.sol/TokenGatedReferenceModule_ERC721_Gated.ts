...
export interface TokenGatedReferenceModule_ERC721_GatedInterface
  ...
  functions: {
    ...
    "testCannotProcessComment_IfNotEnoughBalance(uint256,uint256)": FunctionFragment;
    "testCannotProcessMirror_IfNotEnoughBalance(uint256,uint256)": FunctionFragment;
    "testCannotProcessQuote_IfNotEnoughBalance(uint256,uint256)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testKeyExists()": FunctionFragment;
    "testProcessComment_HoldingEnoughTokens(uint256,uint256)": FunctionFragment;
    "testProcessMirror_HoldingEnoughTokens(uint256,uint256)": FunctionFragment;
    "testProcessQuote_HoldingEnoughTokens(uint256,uint256)": FunctionFragment;
...
export interface TokenGatedReferenceModule_ERC721_Gated extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenGatedReferenceModule_ERC721_GatedInterface;
