...
export interface TokenGatedReferenceModuleInterface extends utils.Interface {
  functions: {
...
export interface TokenGatedReferenceModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenGatedReferenceModuleInterface;
