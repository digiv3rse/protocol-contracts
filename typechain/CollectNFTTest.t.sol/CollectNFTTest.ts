...
export interface CollectNFTTestInterface extends utils.Interface {
  functions: {
    ...
    "testCannot_MintNotFromActionModule(address,address)": FunctionFragment;
    ...
    "testCollectNFTTest()": FunctionFragment;
    ...
    "testGetSourcePublicationPointer(address,address,uint256,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testCannot_MintNotFromActionModule"
  ...
  encodeFunctionData(
    functionFragment: "testCannot_MintNotFromActionModule",
    values: [string, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testCollectNFTTest",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CollectNFTTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollectNFTTestInterface;
  ...
  callStatic: {
    ...
    testCollectNFTTest(overrides?: CallOverrides): Promise<void>;
