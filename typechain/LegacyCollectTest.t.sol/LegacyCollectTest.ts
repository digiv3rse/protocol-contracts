...
export interface LegacyCollectTestInterface extends utils.Interface {
  functions: {
...
export interface LegacyCollectTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyCollectTestInterface;
