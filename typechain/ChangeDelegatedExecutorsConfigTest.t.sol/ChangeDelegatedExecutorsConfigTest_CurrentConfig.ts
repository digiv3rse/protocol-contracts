...
export interface ChangeDelegatedExecutorsConfigTest_CurrentConfigInterface
...
export interface ChangeDelegatedExecutorsConfigTest_CurrentConfig
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChangeDelegatedExecutorsConfigTest_CurrentConfigInterface;
