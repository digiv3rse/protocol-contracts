...
export interface S06_InteractWithDiGiV2Interface extends utils.Interface {
  functions: {
...
export interface S06_InteractWithDiGiV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: S06_InteractWithDiGiV2Interface;
