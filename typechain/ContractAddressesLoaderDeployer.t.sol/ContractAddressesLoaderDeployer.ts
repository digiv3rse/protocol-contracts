...
export interface ContractAddressesLoaderDeployerInterface
...
export interface ContractAddressesLoaderDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ContractAddressesLoaderDeployerInterface;
