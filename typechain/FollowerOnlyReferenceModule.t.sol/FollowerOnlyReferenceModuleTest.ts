...
export interface FollowerOnlyReferenceModuleTestInterface
  ...
  functions: {
    ...
    "testCannotProcessComment_IfNotFollowing(uint256,uint256)": FunctionFragment;
    "testCannotProcessMirror_IfNotFollowing(uint256,uint256)": FunctionFragment;
    "testCannotProcessQuote_IfNotFollowing(uint256,uint256)": FunctionFragment;
    "testContractAddressesLoaderDeployer()": FunctionFragment;
    "testForkManagement()": FunctionFragment;
    "testInitialize(address,uint256,uint256)": FunctionFragment;
    "testKeyExists()": FunctionFragment;
    "testProcessComment_IfFollowing(uint256,uint256)": FunctionFragment;
    "testProcessMirror_IfFollowing(uint256,uint256)": FunctionFragment;
    "testProcessQuote_IfFollowing(uint256,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testArrayHelpers"
      | "testBaseTest"
      | "testCannotProcessComment_IfNotFollowing"
      | "testCannotProcessMirror_IfNotFollowing"
      | "testCannotProcessQuote_IfNotFollowing"
      | "testContractAddressesLoaderDeployer"
      | "testForkManagement"
      | "testInitialize"
      | "testKeyExists"
      | "testProcessComment_IfFollowing"
      | "testProcessMirror_IfFollowing"
      | "testProcessQuote_IfFollowing"
      | "testTestSetup"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCannotProcessComment_IfNotFollowing",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotProcessMirror_IfNotFollowing",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testCannotProcessQuote_IfNotFollowing",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testProcessComment_IfFollowing",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testProcessMirror_IfFollowing",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testProcessQuote_IfFollowing",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface FollowerOnlyReferenceModuleTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FollowerOnlyReferenceModuleTestInterface;
  ...
  functions: {
    ...
    testInitialize(
      from: string,
      fuzzProfileId: BigNumberish,
      fuzzPubId: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
