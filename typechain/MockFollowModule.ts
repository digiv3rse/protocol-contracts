...
export interface MockFollowModuleInterface extends utils.Interface {
  functions: {
    ...
    "testMockFollowModule()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testMockFollowModule",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MockFollowModule extends BaseContract {
  ...
  callStatic: {
    ...
    testMockFollowModule(overrides?: CallOverrides): Promise<void>;
