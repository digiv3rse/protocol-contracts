...
export interface DiGiSeaDropCollectionInterface extends utils.Interface {
  functions: {
    ...
    "initialize(address,string,string,address[],(uint256,string,string,address,(uint80,uint48,uint48,uint16,uint16,bool),string,(bytes32,string[],string),address,bytes32,address[],address[],address[],address[],address[],(uint80,uint16,uint48,uint48,uint8,uint32,uint16,bool)[],address[],address[],(uint80,uint24,uint40,uint40,uint40,uint16,uint16)[],address[]))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "initialize(address,string,string,address[],(uint256,string,string,address,(uint80,uint48,uint48,uint16,uint16,bool),string,(bytes32,string[],string),address,bytes32,address[],address[],address[],address[],address[],(uint80,uint16,uint48,uint48,uint8,uint32,uint16,bool)[],address[],address[],(uint80,uint24,uint40,uint40,uint40,uint16,uint16)[],address[]))"
      | "isApprovedForAll"
      | "maxSupply"
      | "mintSeaDrop"
      | "multiConfigure"
  ...
  encodeFunctionData(
    functionFragment: "initialize(address,string,string,address[],(uint256,string,string,address,(uint80,uint48,uint48,uint16,uint16,bool),string,(bytes32,string[],string),address,bytes32,address[],address[],address[],address[],address[],(uint80,uint16,uint48,uint48,uint8,uint32,uint16,bool)[],address[],address[],(uint80,uint24,uint40,uint40,uint40,uint16,uint16)[],address[]))",
    values: [
      string,
      string,
      string,
...
export interface DiGiSeaDropCollection extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DiGiSeaDropCollectionInterface;
