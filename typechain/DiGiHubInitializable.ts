...
export interface DiGiHubInitializableInterface extends utils.Interface {
  functions: {
...
export interface DiGiHubInitializable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DiGiHubInitializableInterface;
