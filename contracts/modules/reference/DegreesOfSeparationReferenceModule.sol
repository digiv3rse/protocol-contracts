 ...
 */
contract DegreesOfSeparationReferenceModule is DiGiModuleMetadata, HubRestricted, IReferenceModule {
    ...
    function initializeReferenceModule(
        ...
        uint96 originalAuthorProfile;
        Types.PublicationMemory memory pub = IDiGiHub(HUB).getPublication(profileId, pubId);
