 ...
 *
 * @dev This is the CollectNFT for DiGi V2, it differs from LegacyCollectNFT that it's restricted to be called by an
 ...
 */
contract CollectNFT is DiGiBaseERC721, ERC2981CollectionRoyalties, ActionRestricted, ICollectNFT {
