 ...
 *
 * @notice This is a simple DiGi CollectModule implementation, allowing customization of time to collect, number of collects,
 ...
 */
contract MultirecipientFeeCollectModule is BaseFeeCollectModule, DiGiModuleMetadata {
    ...
    constructor(
        ...
        address moduleOwner
    ) BaseFeeCollectModule(hub, actionModule, moduleRegistry) DiGiModuleMetadata(moduleOwner) {}
    ...
    function supportsInterface(
        bytes4 interfaceID
    ) public pure override(BaseFeeCollectModule, DiGiModule) returns (bool) {
        return BaseFeeCollectModule.supportsInterface(interfaceID) || DiGiModule.supportsInterface(interfaceID);
    }
}
