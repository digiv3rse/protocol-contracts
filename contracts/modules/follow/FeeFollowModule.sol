 ...
 */
contract FeeFollowModule is DiGiModuleMetadata, FeeModuleBase, HubRestricted, IFollowModule {
    ...
    constructor(
        ...
        address moduleOwner
    ) FeeModuleBase(hub, moduleRegistry) HubRestricted(hub) DiGiModuleMetadata(moduleOwner) {}
