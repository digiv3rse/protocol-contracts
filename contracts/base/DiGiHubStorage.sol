...
/**
 * @title DiGiHubStorage
 * @author DiGi Protocol
 *
 * @notice This is an abstract contract that ONLY contains storage for the DiGiHub contract. This MUST be inherited last
 * to preserve the DiGiHub storage layout. Adding storage variables should be done ONLY at the bottom of this contract.
 */
abstract contract DiGiHubStorage {
    // For upgradeability purposes, used at `VersionedInitializable` file, which needs to be included if the DiGiHub
