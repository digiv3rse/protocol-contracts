...
abstract contract DiGiProfiles is DiGiBaseERC721, ERC2981CollectionRoyalties, IDiGiProfiles {
    ...
    function burn(
        uint256 tokenId
    ) public override(DiGiBaseERC721, IERC721Burnable) whenNotPaused onlyProfileOwner(msg.sender, tokenId) {
        _burn(tokenId);
    }
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(DiGiBaseERC721, ERC2981CollectionRoyalties, IERC165) returns (bool) {
        return
