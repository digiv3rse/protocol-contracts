...
library StorageLib {
    ...
    // Slot 6 is deprecated in DiGi V2. In V1 it was used for ERC-721 Enumerable's `ownedTokens`.
    // Slot 7 is deprecated in DiGi V2. In V1 it was used for ERC-721 Enumerable's `ownedTokensIndex`.
    // uint256 constant TOTAL_SUPPLY_SLOT = 8;
    // Slot 9 is deprecated in DiGi V2. In V1 it was used for ERC-721 Enumerable's `allTokensIndex`.
    ...
    // Slot 14 is deprecated in DiGi V2. In V1 it was used for the follow module address whitelist.
    // Slot 15 is deprecated in DiGi V2. In V1 it was used for the collect module address whitelist.
    // Slot 16 is deprecated in DiGi V2. In V1 it was used for the reference module address whitelist.
    // Slot 17 is deprecated in DiGi V2. In V1 it was used for the dispatcher address by profile ID.
    ...
    // Slot 21 is deprecated in DiGi V2. In V1 it was used for the default profile ID by address.
