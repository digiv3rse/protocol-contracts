 ...
 *
 * @notice This is the deprecated interface for previously DiGi-compatible FollowModules.
 */
interface ILegacyFollowModule {
    /**
     * @notice Initializes a follow module for a given DiGi profile. This can only be called by the hub contract.
     *
    ...
    /**
     * @notice Processes a given follow, this can only be called from the DiGiHub contract.
     *
