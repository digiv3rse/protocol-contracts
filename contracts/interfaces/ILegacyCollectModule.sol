 ...
 *
 * @notice This is the deprecated interface for previously DiGi-compatible CollectModules.
 */
interface ILegacyCollectModule {
     ...
     *
     * @param referrerProfileId The DiGiHub profile token ID of the referrer's profile (only different in case of mirrors).
     * @param collector The collector address.
     * @param profileId The token ID of the profile associated with the publication being collected.
     * @param pubId The DiGiHub publication ID associated with the publication being collected.
