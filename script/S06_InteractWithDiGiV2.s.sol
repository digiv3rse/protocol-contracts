...
contract S06_InteractWithDiGiV2 is Script, ForkManagement, ArrayHelpers {
    ...
    function _interact() internal {
        ...
        governanceContract.digiHub_whitelistProfileCreator(address(temporarilyCreationProxy), true);
        vm.stopBroadcast();
        ...
        // TODO: Replace this with a true governance for a fork from production
        vm.startBroadcast(governance.ownerPk);
        governanceContract.digiHub_whitelistProfileCreator(address(temporarilyCreationProxy), false);
        vm.stopBroadcast();
    }
