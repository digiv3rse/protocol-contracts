...
contract UpgradeForkTest is BaseTest {
    ...
    function _prepareUpgradeContract() internal {
        ...
        digiV2UpgradeContract = new DiGiV2UpgradeContract({
        ...
        vm.label(address(digiV2UpgradeContract), 'DiGiV2UpgradeContract');
    ...
    function _upgradeV1toV2() internal {
        console.log('Trying to Upgrade to V2 using DiGiV2UpgradeContract...');
        vm.prank(governanceMultisig);
    ...
    function testDiGiUpgradeVersion() public onlyFork {
        if (forkVersion == 2) {
            return;
        }
        _prepareUpgradeContract();
        vm.expectEmit(true, true, true, true, address(hub));
        emit DiGiUpgradeVersion({
