...
contract ContractAddresses {
    ...
    address deployer;
    address governance; // TODO: We need to make this digiHubGovernance (maybe even a function that will return it dynamically)
    address governanceMultisig;
    address treasury;
    address proxyAdmin; // TODO: This needs to be a function that goes to digiHub and gets it.
