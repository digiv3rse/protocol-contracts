...
contract DegreesOfSeparationReferenceModuleTest is BaseTest {
    ...
    function testCannotInitialize_IfSenderIsNotTheDiGiHub(address notHub) public {
    ...
    //     _mockDiGiHubPubCountResponse({account: currentPublisher, pubCount: 1});
    ...
    function testProcessQuote_WhenRestrictedWithZeroDegrees_ButCurrentPublisherIsSourceProfile() public {
        ...
        _mockDiGiHubPubCountResponse({account: originalPublisher, pubCount: 2});
    ...
    function _mockDiGiHubPubCountResponse(TestAccount memory account, uint256 pubCount) internal {
